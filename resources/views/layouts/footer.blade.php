    ...
    <div class="content py-3">
        ...
        <div class="row font-size-sm">
            ...
            <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-right">
                ...
                Designed and Developed by <a href="https://www.logic-valley.com" traget="_blank">Logic Valley (Pvt) Ltd</a>.

            </div>

            <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-left">

                &copy; <span data-toggle="year-copy"></span> <a class="font-w600" href="#" target="_blank">{{ env('APP_NAME', 'Sufra') }}</a>
