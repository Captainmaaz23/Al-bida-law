    ...
    <div class="js-sidebar-scroll">                
        <div class="content-side">
            <ul class="nav-main">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link {{ request()->is('/law-services') ? 'active' : '' }}" href="{{ url('/law-services') }}">
                        <i class="nav-main-link-icon si si-layers"></i>
                ...
                <li class="nav-main-item {{ request()->is('menus/active-listing') || request()->is('question') || request()->is('menus/inactive-listing') || request()->is('menus*') || request()->is('about') ? 'open' : '' }}">
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('question') ? 'active' : '' }}" href="{{ url('/question') }}">
                ...
                <li class="nav-main-item {{ request()->is('items/active-listing') || request()->is('items/inactive-listing') || request()->is('items*') ? 'open' : '' }}">
                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="{{ request()->is('items/active-listing') || request()->is('items/inactive-listing') || request()->is('items*') || request()->is('/blog-post') ? 'true' : 'false' }}" href="#">
                        <i class="nav-main-link-icon si si-social-dropbox"></i>
                        <span class="nav-main-link-name">Blogs</span>
                    </a>
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('/blog-post') ? 'active' : '' }}" href="{{ url('/blog-post') }}">
                                <span class="nav-main-link-name">Blogs</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                ...
                <li class="nav-main-item {{ request()->is('app-users/active-listing') || request()->is('app-users/inactive-listing') || request()->is('app-users*') ? 'open' : '' }}">
                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="{{ request()->is('app-users/active-listing') || request()->is('app-users/inactive-listing') || request()->is('app-users*') || request()->is('our-team') ? 'true' : 'false' }}" href="#">
                        <i class="nav-main-link-icon si si-social-dropbox"></i>
                        <span class="nav-main-link-name">App Users</span>
                    </a>
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('our-team') ? 'active' : '' }}" href="{{ url('/our-team') }}">
                                <span class="nav-main-link-name">Team Member</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                    ...
                    <ul class="nav-main-submenu">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('client_review') ? 'active' : '' }}" href="{{ url('/client_review') }}">
                                <span class="nav-main-link-name">Client Review</span>
                            </a>
                        </li>
                        @endcan  
                        @can('chooseus')
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('chooseus') ? 'active' : '' }}" href="{{ url('/chooseus') }}">
                                <span class="nav-main-link-name">Choose Us</span>
                            </a>
                        </li>
                        @endcan  
                        @can('vission')
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('vission') ? 'active' : '' }}" href="{{ url('/vission') }}">
                                <span class="nav-main-link-name">Vission</span>
                            </a>
                        </li>
                        @endcan  
                        @can('mission')
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('mission') ? 'active' : '' }}" href="{{ url('/mission') }}">
                                <span class="nav-main-link-name">Mission</span>
                            </a>
                        </li>
                        @endcan  
                        @can('certificate')
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('certificate') ? 'active' : '' }}" href="{{ url('/certificate') }}">
                        ...
                        @can('founder')
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('founder') ? 'active' : '' }}" href="{{ url('/founder') }}">
                                <span class="nav-main-link-name">Founder</span>
                            </a>
                        </li>
                        @endcan  
                        @can('case-study')
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('case-study') ? 'active' : '' }}" href="{{ url('/case-study') }}">
                                <span class="nav-main-link-name">Case Study</span>
                            </a>
                        </li>
                        @endcan  
                        @can('slidder')
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('slidder') ? 'active' : '' }}" href="{{ url('/slidder') }}">
                                <span class="nav-main-link-name">Slidder</span>
                            </a>
                        </li>
                        @endcan  
                        @can('web-logo')
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('web-logo') ? 'active' : '' }}" href="{{ url('/web-logo') }}">
                        ...
                        @can('contact')
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('contact') ? 'active' : '' }}" href="{{ url('/contact') }}">
                        ...
                        @can('company-detail')
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ request()->is('company-detail') ? 'active' : '' }}" href="{{ url('/company-detail') }}">
                                <span class="nav-main-link-name">Company Detail</span>
                            </a>
                        </li>
                        @endcan  
                        @can('roles-listing')
