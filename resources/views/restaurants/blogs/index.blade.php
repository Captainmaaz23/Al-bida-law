        ...
        <div class="content">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                ...
                @can('blog-posts.create')
                    <a href="{{ route('blog-post.create') }}" class="btn btn-primary btn-add-new pull-right">
                            ...
                            <table class="table table-striped table-hover" id="myDataTable">
                                <thead>
                                    <tr role="row" class="heading">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" id="s_description" autocomplete="off" placeholder="Description">
                                        </td>
                                        <td>
...
<script>
    jQuery(document).ready(function () {
        let tableOptions = {
            ...
            ajax: {
                url: "{!! route('blog-post-table') !!}",
                data: function (d) {
                    d.name = $('#s_name').val();
                    d.description = $('#s_description').val();
                }
            },
            columns: [
                { data: 'name', name: 'name' },
        ...
        // Filters
        ['s_name', 's_description'].forEach(function (id) {
