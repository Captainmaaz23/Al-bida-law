...
<div class="bg-body-light">
    <div class="content">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill h3 my-2">Certificate Details</h1>
        </div>
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <nav class="flex-sm-00-auto" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                    ...
                    <li class="breadcrumb-item">
                        <a class="link-fx" href="{{ route('certificate.index') }}">Certificate</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Certificate Detail</li>
                </ol>
            </nav>               
            <a href="{{ route('certificate.index') }}" class="btn btn-dark btn-return pull-right">
...
<div class="content">                
    <div class="block block-rounded block-themed">
        ...
        <div class="block-content">
            ...
            <div class="mt-4 row">
                <div class="col-md-3">
                    <label style="font-weight: bold;">English Description</label>
                </div>
           ...
           <div class="mt-4 row">
            ...
            <div class="col-6">
                    <div class="col-md-6">
                        <img src="{{ url('public/uploads/certificates/'.$certificate->image) }}" alt="" style="width: 150px; height: auto;">
                    </div>
            </div>
           </div>
