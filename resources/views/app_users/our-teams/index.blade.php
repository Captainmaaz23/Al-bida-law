    ...
    <div class="bg-body-light">
        <div class="content">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                ...
                @can('law-services.create')
                    <a href="{{ route('our-team.create') }}" class="btn btn-primary btn-add-new pull-right">
                        <i class="fa fa-plus-square fa-lg"></i> Add New
                    </a>

                    {{-- <a href="{{ route('front.home') }}" class="btn btn-primary btn-add-new pull-right">
                        <i class="fa fa-plus-square fa-lg"></i> Website
                    </a> --}}
                @endcan
            </div>
