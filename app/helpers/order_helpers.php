...
if (!function_exists('get_order_status')) {
    function get_order_status($Record) {
        ...
        $order = [
            ...
            'table_id'        => (int) $Record['table_id'],
            'order_no'        => $Record['order_no'],
            'pickup_duration' => calculate_pickup_duration($Record, TRUE),
            'pickup_duration_mins' => calculate_pickup_duration($Record)
        ];
