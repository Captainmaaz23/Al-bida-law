<?php 
$states = $states_array['yesterday'];
?>

<div class="row state_option_div hide" id="state_div_yesterday">

    <div class="col-xl-8 col-xxl-9 d-flex flex-column">
        <div class="block block-rounded flex-grow-1 d-flex flex-column">
            <div class="block-header block-header-default">
                <h3 class="block-title">Yesterday Summary</h3>
            </div>
            <div class="block-content block-content-full align-items-center">
            
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
            			<div id="yesterdaySalesChart" style="width:100%"></div>
                	</div>
                </div>
...
function yesterdaySalesChart() 
{
	var options = 
	{
		series: [
			{
				name: 'Orders',
				type: 'column',
				data: [{{ $states['previousday_orders'] }},{{ $states['yesterday_orders'] }},{{ $states['today_orders'] }}]
			}
		],
		chart: {
			width: '100%',		
		...
		labels: ['{{ $states['previousday_name'] }}','Yesterday','Today'],	
	
	};
	
	var chart = new ApexCharts(document.querySelector("#yesterdaySalesChart"), options);
